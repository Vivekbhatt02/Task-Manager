  ...
  return (
    <>
      ...
      <div className="m-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-1/2">
        ...
        <input className='my-4' onChange={toggleFinished} type="checkbox" id='show' checked={showfinished} />
        <label className='mx-2' htmlFor="show">Show Finished</label>
        <div className='h-[1px] bg-black opacity-15 w-[90%] mx-auto my-2'><hr /></div>
        <h2 className='text-lg font-bold'>Your Todos</h2>
        <div className="todos">
          {todos.length === 0 && <div className='m-5'>No Todos to dispay</div>}
          {todos.map(item => {
